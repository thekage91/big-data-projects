module.exports = function(app) {
  ...
  api.editFilm = function (req, res) {
    ...
    Film.findById(id, function (err, film) {
      ...
      if(typeof req.body.film["county"] != 'undefined'){
        film["county"] = req.body.film["county"];
      }
  ...
  app.get('/api/films', api.films);
  app.get('/api/film/:id', api.film);
  app.post('/api/film', api.addFilm);
  app.put('/api/film/:id', api.editFilm);
  app.delete('/api/film/:id', api.deleteFilm);
};
