...
describe('Query: Retrieve first 5 actors which acted more times with a certain director', function () {
    ...
    describe('Version 2', function () {
        ...
        it('Retrieves right top 5 actors', function (done) {
            ...
            query_interface.top_5_actors_of_a_director(2, saved_director, (err, actors) => {
                if(err) throw err;
    ...
    describe('Version 3', function () {
        ...
        it('Retrieves right top 5 actors', function (done) {
            ...
            query_interface.top_5_actors_of_a_director(3, saved_director, (err, actors) => {
                if (err) throw err;
            ...
            describe('Version 4', function () {
                ...
                it('Retrieves right top 5 actors', function (done) {
                    ...
                    query_interface.top_5_actors_of_a_director(4, saved_director, (err, actors) => {
                        if(err) throw err;
            ...
            describe('Version 5', function () {
                ...
                it('Retrieves right top 5 actors', function (done) {
                    ...
                    query_interface.top_5_actors_of_a_director(5, saved_director, (err, actors) => {
                        if(err) throw err;
    ...
    describe('Version 6', function () {
        ...
        it('Retrieves right top 5 actors', function (done) {
            ...
            query_interface.top_5_actors_of_a_director(6, saved_director, (err, actors) => {
                if(err) throw err;
                console.log(actors);
                actors.length.should.be.eql(5);
                actors[0].id.should.be.eql(''+saved_actor_100_movies.first_name+saved_actor_100_movies.last_name);
